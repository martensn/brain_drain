# memo1_08d_scheme_comparison.R (was memo1_06b_scheme_comparison.R)
#
...
# (memo1_09c_cohort_scheme_comparison.R) -- this script was the one place
...
# memo1_09c_cohort_scheme_comparison.R (see that file for the original
