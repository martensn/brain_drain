...
write.csv(cohort_return_hs,file.path(directory,"Data/06/cohort_return_hs_10.csv"),row.names = FALSE)
write.csv(cohort_return_col,file.path(directory,"Data/06/cohort_return_col_10.csv"),row.names = FALSE)
...
##    Create Summary Statistic Measures

```{r sumstat}

institutional_characteristics <- fread(file.path(directory,"Data/06","institutional_characteristics.csv"))
...
write.csv(cohort_x_grad,file.path(directory,"Data/06/cohort_x_grad.csv"),row.names = FALSE)
