# memo1_09c_cohort_scheme_comparison.R (was memo1_07c_cohort_scheme_comparison.R)
#
# [NEW 2026-08-12] Generalizes Code/memo1_08d_scheme_comparison.R's run_scheme()
...
# built by Code/memo1_09a_cohort_inputs.R, per Nicholas's request. Adds a
...
#
# Standalone -- does not touch memo1_08d_scheme_comparison.R or its outputs.
# Requires Code/memo1_09a_cohort_inputs.R and Code/memo1_07b_cohort_
...
for (cohort_name in COHORTS) {
  ...
  # Code/memo1_09d_cohort_demo_table.R to apply the same calibration to a
